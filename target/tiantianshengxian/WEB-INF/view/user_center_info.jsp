...
<body>
	...
	<div class="main_con clearfix">
		...
		<div class="right_content clearfix">
				...
				<li>
					<a href="detail.jsp"><img src="${pageContext.request.contextPath}/resource/images/goods/goods003.jpg"></a>
				...
				<li>
					<a href="#"><img src="${pageContext.request.contextPath}/resource/images/goods/goods004.jpg"></a>
				...
				<li>
					<a href="#"><img src="${pageContext.request.contextPath}/resource/images/goods/goods005.jpg"></a>
					<h4><a href="#">黄肉桃</a></h4>
					<div class="operate">
				...
				<li>
					<a href="#"><img src="${pageContext.request.contextPath}/resource/images/goods/goods006.jpg"></a>
					<h4><a href="#">进口西梅</a></h4>
					<div class="operate">
				...
				<li>
					<a href="#"><img src="${pageContext.request.contextPath}/resource/images/goods/goods007.jpg"></a>
					<h4><a href="#">香梨</a></h4>
					<div class="operate">
